...
// export const getresturantWithOrders = async (c: Context) =>{
//     try{
//        const StatesWithOrdersata = await resturantService();
//        if (resturantWithOrders == null){
//            return c.text("State not found", 404)
//        } 
//        return c.json(resturantWithOrders, 200);
//     }catch(error:any){
//        return c.json({error: error?.message}, 400)
//     }
// }