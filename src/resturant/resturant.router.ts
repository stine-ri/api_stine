...
import { listresturant, getresturant, createresturant, updateresturant, deleteresturant, getresturantWithOrders } from "./resturant.controller"
import { zValidator } from "@hono/zod-validator";
import { resturantSchema } from "./validator";
export const resturantRouter = new Hono();

//get all resturants      api/resturants
resturantRouter.get("/resturant", getresturantWithOrders);
